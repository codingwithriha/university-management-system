...
'' }}> 
                            {{ $student->name }} ({{ $student->email }}) - Class: {{ $student->class ?? 'Not 
Assigned' }} 
                        </option> 
                    @endforeach 
                </select> 
                <div class="info-text"> 
                        Student must be created by Admin first. Contact admin if you don't see your 
name. 
                </div> 
            </div> 
...
'' }}> 
                            {{ $teacher->name }} ({{ $teacher->email }}) - {{ $teacher->specialization ?? 
'General' }} 
                        </option> 
                    @endforeach 
                </select> 
                <div class="info-text"> 
                        Teacher must be created by Admin first. Contact admin if you don't see your 
name. 
                </div> 
            </div> 
             
            <!-- Info Message for Admin --> 
            <div id="admin_info" class="info-text hidden" style="background: #fff3cd; color: 
#856404;"> 
